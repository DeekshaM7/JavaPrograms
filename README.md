...
***Assignmnet 8 & 10***
**Employee Registration Application using JavaFX with Database Connectivity**
...
This Java program is a simple JavaFX application that implements a database system to manage employee information. The program uses JDBC to connect with a MySQL database. We'll create separate classes for the main application, the employee model, and the controller for handling the UI interactions. Below are the classes:


**DBUtils:** This class contains utility methods for interacting with the database.
...
**LogInController.java:** This class is the controller for the login screen.
...
**ViewDetailController.java:** This class is the controller for the screen that displays the list of employees and allows the user to update an existing employee record.
...
**MainApplication.java:** This class contains the main method and initializes the JavaFX application.

**ViewTable.java:** This class represents a single row in the employee table.
